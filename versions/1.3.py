...
time_soma = 0
errorInfo = False
version = "1.3" # Nova função videoConfigs, antes o titulo e descrição eram inseridor por pyautogui, agora por console
...
class steps:
    def step1Upload():
        ...
        def foundSelectorF():
            ...
            if linkFolderClick is True:
                ...
                errorFunction("linkFolderClick 173")
                return
    ...
    def step2Edit():
        ...
        if detalhes is True:
            ...
            errorFunction("LinkFolderClick 199")
            return
        ...
        if copyright is True or copyright2 is True:
            ...
            if videoPosted is True:
                ...
                videoUploaded = False
                errorFunction("videoPosted 268")
                return
        else:
            errorFunction("copyright 236")
            return
